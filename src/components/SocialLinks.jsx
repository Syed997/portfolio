        ...
        <ul className="flex flex-col gap-1">
            {
                links.map(({id, child, href, style, download})=>(
                    <li key={id} className={`flex justify-between items-center w-40 h-14 px-4 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 bg-white/10 backdrop-blur-md border border-white/10 ${style}`}>
                        <a
                        href={href}
