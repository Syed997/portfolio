...
function Contact() {
  return (
    <div name="contact" className="w-full h-full md:h-screen bg-gradient-to-b from-black to-gray-800 p-4 text-white">
          ...
          <p className="text-4xl font-bold flex justify-center text-red-400">Contact</p>
            ...
            <div className="flex justify-center items-center">
                  <form action="https://getform.io/f/a282e6ca-b440-4609-8759-25efd2524457" method="POST" className="flex flex-col w-full md:w-2/3">
                    ...
                    <button className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-8 mx-auto flex items-center rounded-md hover:scale-110 duration-300 border-2">Submit</button>  
                </form>
            </div>
        </div>
    </div>
